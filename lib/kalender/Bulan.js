...
export function GetJelosolah(bulan, tahun, wuku) {
  const tabel = [
    {
      angkatGawe: ["Senin"],
      pegaweanBangket: ["Selasa"],
      penganjengBale: ["Sabtu", "Minggu"],
      bekelampan: ["Rabu"]
    },

    {
      angkatGawe: ["Selasa"],
      pegaweanBangket: ["Rabu"],
      penganjengBale: ["Minggu", "Senin"],
      bekelampan: ["Kamis"]
    },

    {
      angkatGawe: ["Rabu"],
      pegaweanBangket: ["Kamis"],
      penganjengBale: ["Senin", "Selasa"],
      bekelampan: ["Jumat"]
    },

    {
      angkatGawe: ["Kamis"],
      pegaweanBangket: ["Jumat"],
      penganjengBale: ["Selasa", "Rabu"],
      bekelampan: ["Sabtu"]
    },

    {
      angkatGawe: ["Jumat"],
      pegaweanBangket: ["Sabtu"],
      penganjengBale: ["Rabu", "Kamis"],
      bekelampan: ["Minggu"]
    },

    {
      angkatGawe: ["Sabtu"],
      pegaweanBangket: ["Minggu"],
      penganjengBale: ["Kamis", "Jumat"],
      bekelampan: ["Senin"]
    }
  ];
